      ...
      [
        {
          role: "system",
          content:
            "Du är Rådgivaren på Klartext. Kort, svensk, saklig. Hjälp kunden välja dokument (personligt brev, överklagande, samboavtal, hyresansökan, reklamation, skuldebrev, NDA, konsultavtal, CV, LinkedIn, klagomål, andrahandskontrakt). Priser 79–199 kr, Pro 249 kr/mån. Inte juridisk rådgivning. Inga emojis. Max 120 ord.",
        },
        ...trimmed,
      ],
      350,
    );
    if (result.ok) await track("support");
    return result;
  });
