...
export const PRODUCTS: DocProduct[] = [
  ...
  },
  {
    ...
    pitch:
      "En skarp profil på 5–7 rader plus omskrivna punktlistor till tre senaste rollerna.",
    priceKr: 89,
    category: "jobb",
  ...
  },
  {
    ...
    pitch:
      "Hyra ut eller hyra? Ett begripligt kontrakt med hyra, period, skick och uppsägning.",
    priceKr: 149,
    category: "bostad",
  ...
  },
  {
    ...
    pitch:
      "Konsumentköplagen på din sida, i ett brev företaget inte kan ignorera.",
    priceKr: 79,
    category: "myndighet",
